...
VisualVM 的截图展示了这个溢出结果。可以看到 Eden 区刚开始还是运行平稳的，内存泄漏之后就开始疯狂回收（其实是提升），老年代内存一直增长，直到 OOM。
 ...
        ![Cgq2xl5DytGAc09TAAFdBh0n9eo313.jpg][]      
...
java -Xmx20m   -XX:+UseG1GC  -verbose:gc -Xlog:gc,gc+ref=debug,gc+heap=debug,gc+age=trace:file=/tmp/logs/gc\_%p.log:tags,uptime,time,level -Xlog:safepoint:file=/tmp/logs/safepoint\_%p.log:tags,uptime,time,level -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp/logs -XX:ErrorFile=/tmp/logs/hs\_error\_pid%p.log -XX:-OmitStackTraceInFastThrow  OOMTest
 ...
        ![CgpOIF5DytKAIL4RAAE2rXZgveA253.jpg][]      
...
Heap dump file created \[17362313 bytes in 0.134 secs\]
 ...
        ![Cgq2xl5DytKAMGfeAAE5q9rh1rM558.jpg][]      
...
这是趣味性和技巧性非常突出的一个问题。让我们执行 dmesg 命令，大概率会看到你的进程崩溃信息躺在那里。
 ...
        ![CgpOIF5DytKAL-kVAAEITZsHixY196.jpg][]      
...
[Cgq2xl5DytGAc09TAAFdBh0n9eo313.jpg]: https://s0.lgstatic.com/i/image3/M01/65/E6/Cgq2xl5DytGAc09TAAFdBh0n9eo313.jpg
[CgpOIF5DytKAIL4RAAE2rXZgveA253.jpg]: https://s0.lgstatic.com/i/image3/M01/65/E5/CgpOIF5DytKAIL4RAAE2rXZgveA253.jpg
[Cgq2xl5DytKAMGfeAAE5q9rh1rM558.jpg]: https://s0.lgstatic.com/i/image3/M01/65/E6/Cgq2xl5DytKAMGfeAAE5q9rh1rM558.jpg
[CgpOIF5DytKAL-kVAAEITZsHixY196.jpg]: https://s0.lgstatic.com/i/image3/M01/65/E5/CgpOIF5DytKAL-kVAAEITZsHixY196.jpg
